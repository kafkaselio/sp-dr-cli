...
![npm version](https://img.shields.io/npm/v/mechbuild?color=00f5ff&labelColor=0d0d0d)
![License: MIT](https://img.shields.io/badge/License-MIT-7b2fff?labelColor=0d0d0d)
![Node](https://img.shields.io/badge/Node.js-18%2B-00ff87?labelColor=0d0d0d)
![TypeScript](https://img.shields.io/badge/TypeScript-5.x-3178c6?labelColor=0d0d0d)
...
Commit using conventional commits — `feat: add X`, `fix: resolve Y`
